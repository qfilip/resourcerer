...
{
    public static Expression<Func<T, T>> GetDefaultProjection<T>() where T : IId<Guid>, IAuditedEntity, ISoftDeletable, new()
    {
    ...
    public static Expression<Func<T, T>> Expand<T>(Expression<Func<T, T>> selector) where T : IId<Guid>, IAuditedEntity, ISoftDeletable, new()
    {
    ...
    public static Expression<Func<T, TDto>> GetDefaultCustomProjection<T, TDto>()
        where T : IId<Guid>, IAuditedEntity, ISoftDeletable, new()
