...
//                (glass, 0d, 2),
//                (metal, 0d, 1)
//            }, new List<ElementInstanceSoldEvent>());
...
//        GetExpectedValues(List<(Element E, double UnitsUsedInComposites, int UsedInComposites)> elementData, List<ElementInstanceSoldEvent> soldEvents)
//    {
