...
public class GetAllElementsStatisticsTests
{
    ...
    public async void CorrectlySumsUsageDetails_When_CompositeIsSold_And_ElementIsSold()
    {
        ...
        AssertStats(glassStats, unitsUsedInComposites: 7, unitsInStock: 0, unitsPurchased: 20, purchaseCosts: 20);
        AssertStats(metalStats, unitsUsedInComposites: 10, unitsInStock: 0, unitsPurchased: 20, purchaseCosts: 40);
    }
